...
} = require('./src/providers/provider-factory.js');
...
} = require('./src/providers/provider-capabilities.model.js');
...
test('5.10: Provider instances have getCapabilities method', () => {
  const { createProviderInstance } = require('./src/providers/provider-factory.js');
